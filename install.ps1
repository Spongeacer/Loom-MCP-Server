...
$RepoUrl = "https://github.com/Spongeacer/Loom-MCP-Server.git"
...
if (Test-Path "$InstallDir\.git") {
    Write-Info "Existing installation found at $InstallDir. Pulling latest..."
    git -C "$InstallDir" pull --ff-only
} else {
    Write-Info "Cloning LOOM into $InstallDir..."
...
# 3. Add to PATH via wrapper scripts
...
# 4. MCP auto-config (Kimi / Cline / Roo via VS Code globalStorage simplified)
