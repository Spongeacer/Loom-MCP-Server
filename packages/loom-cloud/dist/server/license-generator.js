...
import { generateLicenseKeyPair, generateLicense, validateLicense, } from '../license.js';
// ─────────────────────────────────────────────────────────────────────────────
// CLI
// ─────────────────────────────────────────────────────────────────────────────
function printUsage() {
...
for device-side offline validation.`);
    ...
    const privateKeyPath = typeof args.private_key === 'string'
        ? args.private_key
...
main();
//# sourceMappingURL=license-generator.js.map